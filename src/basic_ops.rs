...
#[test]
fn bignum_add_test() {
    assert_eq!(try_with_strs(Bignum::add, "123", "123"), "246");
    assert_eq!(try_with_strs(Bignum::add, "123", "0"), "123");
    assert_eq!(try_with_strs(Bignum::add, "123", "10000"), "10123");
    assert_eq!(try_with_strs(Bignum::add, "123456789", "987654321"), "1111111110");
}

#[test]
fn bignum_sub_test() {
    assert_eq!(try_with_strs(Bignum::sub, "123", "123"), "0");
    assert_eq!(try_with_strs(Bignum::sub, "123", "0"), "123");
    assert_eq!(try_with_strs(Bignum::sub, "123", "10000"), "-9877");
    assert_eq!(try_with_strs(Bignum::sub, "123456789", "987654321"), "-864197532");
}
